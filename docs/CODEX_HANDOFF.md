...
1. `docs/rail-splitter.md`の実機確認項目をバックアップ済みワールドで実施する。
2. 問題時は、分割前のレール条件・選択位置・手持ちモデルと、`[SuperRailBuilderX splitter]`周辺の必要最小限のログを共有する。
...
- 2026-09-03 ローカルCodex: 線路分割ツールを含む全3ターゲットのコード生成・ビルドに成功。詳細は `docs/history/CODEX_HISTORY_2026-09.md` を参照。
